...
/// KaraokeScreen controller - uses single responsive view for fullscreen mode
              ...
              children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(widget.track['title'] ?? 'Karaoke', style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold), overflow: TextOverflow.ellipsis),
                            Text(widget.track['artist'] ?? '', style: const TextStyle(color: Colors.white70, fontSize: 12)),
                          ],
                        ),
                      ),
                    ],
                ...
                Expanded(
                  child: StreamBuilder<List<LyricLine>>(
                    ...
                    builder: (context, snapshot) {
                      final lyrics = snapshot.data ?? _playbackService.currentLyrics;
                      if (lyrics.isEmpty) {
                        return const Center(child: Text('Letras não sincronizadas...', style: TextStyle(color: Colors.white54)));
                      }
                          ...
                          return AnimatedContainer(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                ...
                                shadows: isActive ? [Shadow(color: Theme.of(context).colorScheme.primary, blurRadius: 10)] : null,
                              ),
                            ),
                          );
                        },
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      IconButton(iconSize: 48, icon: const Icon(Icons.play_circle_filled, color: Colors.white), onPressed: () => _playbackService.resume()),
                    ],
                  ),
                ),
              ],
