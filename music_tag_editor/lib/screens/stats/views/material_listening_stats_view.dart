          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Top Artistas', style: Theme.of(context).textTheme.titleLarge),
                  const SizedBox(height: 12),
                  _buildList(context, topArtists, Icons.person),
                  const SizedBox(height: 24),
                  Text('Top Músicas', style: Theme.of(context).textTheme.titleLarge),
                  const SizedBox(height: 12),
        ...
        child: Row(
          children: [
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text('${hours}h ${mins}min', style: Theme.of(context).textTheme.headlineMedium?.copyWith(fontWeight: FontWeight.bold)),
            ]),
          ],
        ),
      ),
