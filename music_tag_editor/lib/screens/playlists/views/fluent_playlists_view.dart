                ...
                return Card(
                  ...
                  child: ListTile(
                    leading: Container(
                      ...
                      child: Icon(FluentIcons.playlist_music, color: FluentTheme.of(context).accentColor),
                    ),
                    ...
                    onPressed: () => Navigator.push(context, FluentPageRoute(builder: (_) => PlaylistDetailScreen(playlistId: p['id'], playlistName: p['name']))),
                  ),
                );
              },
            ),
