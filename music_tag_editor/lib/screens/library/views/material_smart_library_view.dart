  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: [
            _SmartList(future: topHitsFuture, onPlayTrack: onPlayTrack, emptyText: 'Dê o play em algumas músicas primeiro!'),
            _SmartList(future: recentDiscoveriesFuture, onPlayTrack: onPlayTrack, emptyText: 'Suas novas músicas aparecerão aqui.'),
          ],
        ),
      ),
    );
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<SearchResult>>(
      ...
      builder: (context, snapshot) {
        ...
        if (tracks.isEmpty) return Center(child: Text(emptyText, style: const TextStyle(color: Colors.grey)));
