...
class MaterialRemoteLibraryView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Biblioteca do Amigo'), actions: [IconButton(icon: const Icon(Icons.refresh), onPressed: onRefresh)]),
      body: isLoading
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      trailing: Row(
                        ...
                        children: [
                          IconButton(icon: const Icon(Icons.add_to_photos), onPressed: () => onAddToQueue(track)),
